...
; Generated by Tim-Oliver Husser on 29/03/2019 (UTC)
;
[Setup]
AppID={{539ebef5-961c-47d9-90ed-59bdc64f3521}
AppName=ASCOM BaaderDome Dome Driver
AppVerName=ASCOM BaaderDome Dome Driver 1.0
AppVersion=1.0
AppPublisher=Tim-Oliver Husser <thusser@uni-goettingen.de>
AppPublisherURL=mailto:thusser@uni-goettingen.de
...
OutputDir="."
OutputBaseFilename="BaaderDome Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\BaaderDome"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\BaaderDome"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\husser\source\repos\ascom_baader_dome\ascom_baader_dome\bin\Release\ASCOM.Baader.Dome.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\husser\source\repos\ascom_baader_dome\ascom_baader_dome\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Baader.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Baader.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Baader.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Baader.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Baader.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
